...
from utils.llm import LLMClient, PROJECT_ROOT
...
MOCK_EVALUATIONS = [
    {
        "turn_number": 1,
        "dimension_scores": [
            {"dimension": "Communication Clarity", "score": 7, "justification": "Answer was well-structured with a clear beginning, middle, and end."},
            {"dimension": "Problem-Solving Approach", "score": 6, "justification": "Mentioned a framework but didn't fully articulate the prioritization criteria used."},
            {"dimension": "Use of Examples", "score": 7, "justification": "Gave a concrete example from their startup experience with specific context."},
            {"dimension": "Critical Thinking", "score": 5, "justification": "Described the decision but didn't explore tradeoffs or alternatives considered."},
            {"dimension": "Self-Awareness", "score": 6, "justification": "Acknowledged the difficulty of the decision but didn't reflect on what they'd do differently."}
        ],
        "overall_score": 6.2,
    ...
    },
    {
        "turn_number": 2,
        "dimension_scores": [
            {"dimension": "Communication Clarity", "score": 8, "justification": "Clearly walked through the feedback gathering process step by step."},
            {"dimension": "Problem-Solving Approach", "score": 7, "justification": "Described a structured approach using surveys, user interviews, and usage data."},
            {"dimension": "Use of Examples", "score": 7, "justification": "Referenced specific numbers — 15 user interviews and NPS survey results."},
            {"dimension": "Critical Thinking", "score": 7, "justification": "Discussed how to weight qualitative vs quantitative feedback."},
            {"dimension": "Self-Awareness", "score": 6, "justification": "Acknowledged that their process has evolved but didn't specify how."}
        ],
        "overall_score": 7.1,
        "strengths": ["Demonstrated a structured, multi-source approach to gathering customer feedback", "Used specific numbers to quantify their process"],
    ...
    },
    {
        "turn_number": 3,
        "dimension_scores": [
            {"dimension": "Communication Clarity", "score": 6, "justification": "Answer started strong but became somewhat disorganized toward the end."},
            {"dimension": "Problem-Solving Approach", "score": 7, "justification": "Showed a collaborative approach to conflict resolution."},
            {"dimension": "Use of Examples", "score": 6, "justification": "Gave an example but lacked specific details about the outcome."},
            {"dimension": "Critical Thinking", "score": 6, "justification": "Described the compromise but didn't fully analyze why it was the right approach."},
            {"dimension": "Self-Awareness", "score": 7, "justification": "Showed awareness of different perspectives and willingness to adapt."}
        ],
        "overall_score": 6.4,
    ...
    },
    {
        "turn_number": 4,
        "dimension_scores": [
            {"dimension": "Communication Clarity", "score": 7, "justification": "Clearly articulated the decision-making framework for choosing compromise."},
            {"dimension": "Problem-Solving Approach", "score": 8, "justification": "Showed sophisticated thinking about when to compromise vs when to hold firm."},
            {"dimension": "Use of Examples", "score": 7, "justification": "Tied the reasoning back to the specific situation with concrete details."},
            {"dimension": "Critical Thinking", "score": 8, "justification": "Excellent analysis of the tradeoffs between shipping speed and technical quality."},
            {"dimension": "Self-Awareness", "score": 7, "justification": "Acknowledged that they've learned to pick their battles more strategically."}
        ],
        "overall_score": 7.5,
        "strengths": ["Strong analysis of tradeoffs between speed and quality", "Showed growth in how they approach disagreements"],
    ...
    },
    {
        "turn_number": 5,
        "dimension_scores": [
            {"dimension": "Communication Clarity", "score": 8, "justification": "Very well-structured walkthrough of the metrics framework."},
            {"dimension": "Problem-Solving Approach", "score": 8, "justification": "Identified leading and lagging indicators, showed funnel thinking."},
            {"dimension": "Use of Examples", "score": 6, "justification": "Stayed somewhat theoretical — didn't tie metrics back to a real experience."},
            {"dimension": "Critical Thinking", "score": 8, "justification": "Discussed guardrail metrics and potential pitfalls of optimizing for wrong metrics."},
            {"dimension": "Self-Awareness", "score": 6, "justification": "Confident answer but didn't acknowledge limitations of the proposed approach."}
        ],
        "overall_score": 7.4,
        "strengths": ["Comprehensive metrics framework covering acquisition, activation, and retention", "Mentioned guardrail metrics to prevent gaming"],
    ...
    },
    {
        "turn_number": 6,
        "dimension_scores": [
            {"dimension": "Communication Clarity", "score": 7, "justification": "Clear narrative structure following the STAR format."},
            {"dimension": "Problem-Solving Approach", "score": 7, "justification": "Described a systematic post-mortem process and corrective actions."},
            {"dimension": "Use of Examples", "score": 8, "justification": "Specific example with concrete failure details and measurable outcome."},
            {"dimension": "Critical Thinking", "score": 7, "justification": "Good reflection on root causes but could have explored systemic issues."},
            {"dimension": "Self-Awareness", "score": 9, "justification": "Excellent vulnerability and genuine learning — admitted what they'd do differently."}
        ],
        "overall_score": 7.5,
        "strengths": ["Showed genuine vulnerability in discussing failure", "Connected the failure to a concrete learning that changed their behavior"],
        "weaknesses": ["Could have explored whether the failure pointed to systemic process issues, not just individual mistakes"],
        "signals": ["move_on"],
        "follow_up_suggestion": None
    }
]
